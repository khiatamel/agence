...
<div class="details">
	<div class="recentOrders" id="div1" style="display:block;">
    ...
    <div class="recentOrders" id="div2" style="display:none;">
	...
	<div class="recentCustomers">
        <div class='demande'>
            <button>Les Demande</button>
        </div>
        <div class='ajouterC'>
            <button id="toggleButton">Programme Omra</button>
        </div>
        <div class='ajouterC'>
            <button id="toggleButton">ajouter omra</button>
        </div>
        <div class='ajouterC'>
            <button id="toggleButton">ajouter client</button>
        </div>
        <div class='ajouterC'>
            <button id="toggleButton">Saisons</button>
        </div>
	</div>
</div>
