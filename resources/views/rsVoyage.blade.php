...
<html>
  <head>
    ...
    <!--=============== CSS ===============-->
    <link rel="stylesheet" href="{{ asset('css/rsVoyage.css') }}">

  </head>
  <body>
  
    <div class="titre"><h1>Réservation</h1></div>
    <div class="container">
      ...
      <form action="#">
        <div class="main-user-info">
          ...
          <div class="user-input-box">
            <label for="password">Photo(Scanner)</label>
            <input type="file" 
                    id="photo" 
                    name="photo" 
    ...
    <div class="container">
      <h1 class="form-title">Personnes 02</h1>
      <form action="#">
        <div class="main-user-info">
          <div class="user-input-box">
            <label for="fullName">Nom</label>
    ...
    <div class="container">
      ...
      <form action="#">
        <div class="main-user-info">
          <div class="user">
             <span class="prix-totale">Prix Totale : </span>
             <span class="prix">500000DA</span>
          </div>
